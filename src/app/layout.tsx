    ...
    <html lang="id">
      <body className={`${poppins.className} min-h-full flex flex-col antialiased`}>
        ...
        <Toaster
          ...
          toastOptions={{
            duration: 4000,
            style: { borderRadius: "10px", color: "#fff", padding: "12px 16px", fontSize: "14px", fontWeight: "500", boxShadow: "0 4px 12px rgba(0,0,0,0.15)" },
            success: { style: { background: "#22c55e", color: "#fff" }, iconTheme: { primary: "#fff", secondary: "#22c55e" } },
