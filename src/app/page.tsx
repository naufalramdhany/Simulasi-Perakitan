            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {komponen.length === 0 ? (
                ...
                komponen.map((item) => (
                  <div
                    key={item.id}
                    className="bg-white rounded-lg shadow hover:shadow-md transition duration-300 overflow-hidden flex flex-col"
                  >
                    <img
                      src={item.gambar}
                      alt={item.nama}
                    ...
                    <div className="p-3 flex flex-col flex-1">
                      ...
                      <p className="text-xs text-gray-600 mt-2 leading-5 flex-1 line-clamp-3">
                        {item.deskripsi}
                      </p>
